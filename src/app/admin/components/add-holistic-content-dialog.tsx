...
type NewContent = Omit<HolisticContent, "id"> & { id: string };

interface AddHolisticContentDialogProps {
  isOpen: boolean;
  onOpenChange: (isOpen: boolean) => void;
  onArticleAdd: (article: NewContent) => void;
}

export function AddHolisticContentDialog({ isOpen, onOpenChange, onArticleAdd }: AddHolisticContentDialogProps) {
  ...
  async function onSubmit(values: z.infer<typeof contentSchema>) {
    ...
    const newArticle: NewContent = { ...values, id: uuidv4() };
    ...
    toast({
      ...
      description: `L'article "${values.title}" a été créé.`,
    });
    form.reset();
  }
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Créez un nouvel article pour le centre de soins holistiques.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="L'art de la pleine conscience..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Un bref résumé de l'article..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
